...
@interface AKImageScrollView ()<UIScrollViewDelegate>

@property (nonatomic, weak) UIImageView *zoomView;  // contains the full image
...
@implementation AKImageScrollView
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        //照片显示
        UIImageView *zoomView = [[UIImageView alloc] initWithFrame:self.bounds];
